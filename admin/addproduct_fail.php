...
<body>
	...
	<div id="main_container">
		...
		<div id="add-panel-container">
			<p id="add-panel-success">Product Addition Failed</p>
			<p id="add-panel-success">Please go back and try again</p>
			<div id="add-product-table-container">
				<button onclick="location.href='addproduct.php'" id="back-button"><img src="../media/back.png" id="back-icon">Back</button>
			</div>
