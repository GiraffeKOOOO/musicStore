...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/update_product_theme.css">
...
<body>
	...
	<div id="main_container">
		...
		<div id="update-panel-container">
			<p id="update-panel-title"><u>Update Product</u></p>
				<p id="update-info-text">select a product to update details for</p>
				<div id="search-div">
					<span id="button-span">
					...
					<span id="search-bar-span">
						<form method="POST" action="php/script-search-update.php">
			...
			<table id="product-table">
				<tr id="product-table-headings">
					...
					<th class="table-heading">Product Stock</th>
				...
				<?php
					...
					echo "
						...
						<tr class='scripted-data' id='scripted-data-id'>
							...
							<td name='product-name'>$product_name[$i]</td>
							<td name='product-category'>$product_category[$i]</td>
							<td name='product-stock'>$product_stock[$i]</td>
							<td name='product-price'>£$product_price[$i]</td>
							<td><a href='../category/product.php?pid=$product_id[$i]'><img src='../media/$product_picture[$i]' class='accessories-picture'></a></td>
							<td><a href='../admin/updateproduct_selected.php?pid=$product_id[$i]' name='button-id-[$i]' class='select-button'>select</a></td>
						</tr>
