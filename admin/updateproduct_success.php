...
<body>
	...
	<div id="main_container">
		...
		<div id="add-panel-container">
			<p id="add-panel-success">Product Updated successfully</p>
			<div id="add-product-table-container">
				<?php 
					$url = $_GET['pid'];
				?>
				<button onclick="location.href='<?php echo "updateproduct_selected.php?pid=$url"; ?>'" id="back-button"><img src="../media/back.png" id="back-icon">Back</button>
			</div>
